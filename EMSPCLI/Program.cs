    ...
    public class Program
    {
        ...
        public static async Task<Int32> Main(String[] Arguments)
        {
            ...
            await using (emsp)
            {
                ...
                // and there would be nobody to type anyway. Then the EMSP simply
                ...
                // 0, a program that said all was well. The vehicle and the
                // charging station ask both, as this does.
                ...
                // reading of Ctrl+C - abandon what is running and shut the EMSP
                ...
                if (canBeTypedAt)
                {
                    ...
                    while (true)
                    {
                        ...
                        // line, and the EMSP's log from whichever thread did the
                        ...
                        emsp.ShareConsoleWith(cli.WriteBlock);
                        ...
                        // the EMSP to stop. What broke the vehicle's and the
                        // charging station's first was a line typed wider than
                        // the window: until Styx learned to show such a line
                        // through a window onto it, it threw out of the line
                        // editor - "Parameter 'left', actual value was 80" in 80
                        // columns - and a program that took that for 'quit' shut
                        // down with exit code 0. That cause is gone; this is for
                        // the next one.
                        //
                        ...
                        emsp.ShareConsoleWith(write => { lock (padlock) { write(); } });
                        ...
                        emsp.Log.Warning(
                            ...
                            (giveUp
                                 ? "A new one broke again as soon as it started, so there is none; the EMSP keeps running, and Ctrl+C stops it."
